...
describe Admin::RequirementLevelsController do
  ...
  test "should show requirement_level" do
    get :show, :id => requirement_levels(:STRY).to_param
    assert_response :success
  end

  test "should get edit" do
    get :edit, :id => requirement_levels(:STRY).to_param
    assert_response :success
  end

  test "should update requirement_level" do
    put :update, :id => requirement_levels(:STRY).to_param, :requirement_level => { }
    assert_redirected_to admin_requirement_level_path(assigns(:requirement_level))
  end

  test "should destroy requirement_level" do
    assert_difference('RequirementLevel.count', -1) do
      delete :destroy, :id => requirement_levels(:STRY).to_param
    end
